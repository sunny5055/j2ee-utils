...
import com.google.code.jee.utils.jsf.scope.CustomScope;
...
public final class FacesUtils {
    ...
    public static String formatDate(FacesContext facesContext, Date date) {
        String formatedDate = null;
        if (facesContext != null && date != null) {
    ...
    public static Object getCustomScopeParameter(FacesContext facesContext, String name) {
        Object value = null;
        if (facesContext != null && !StringUtil.isBlank(name)) {
            final CustomScope customScope = (CustomScope) getSessionAttribute(facesContext, FacesUtils.CUSTOM_SCOPE);
            if (customScope != null) {
                value = customScope.get(name);
            }
        }
        return value;
    }

    public static void setCustomScopeParameter(FacesContext facesContext, String name, Object value) {
        if (facesContext != null && !StringUtil.isBlank(name)) {
            final CustomScope customScope = (CustomScope) getSessionAttribute(facesContext, FacesUtils.CUSTOM_SCOPE);
            if (customScope != null) {
                customScope.put(name, value);
            }
        }
    }

    public static Object getFlashParameter(FacesContext facesContext, String name) {
        Object value = null;
        if (facesContext != null && !StringUtil.isBlank(name)) {
    ...
    public static void setFlashParameter(FacesContext facesContext, String name, Object value) {
        if (facesContext != null && !StringUtil.isBlank(name)) {
            final Flash flash = facesContext.getExternalContext().getFlash();
            if (flash != null) {
    ...
    public static String getAction(FacesContext facesContext, String path, boolean includeViewParams) {
        String action = null;
        if (facesContext != null && !StringUtil.isBlank(path)) {
