...
public class QueryUtil {
    ...
    public static <T> T getByNamedParam(Session session, String queryString, String[] paramNames, Object... values) {
        T dto = null;
        if (session != null && !StringUtil.isBlank(queryString) && !ArrayUtil.isEmpty(paramNames)
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T getByNamedQueryAndNamedParam(Session session, String queryName, String[] paramNames,
            Object... values) {
        T dto = null;
        if (session != null && !StringUtil.isBlank(queryName) && !ArrayUtil.isEmpty(paramNames)
                && !ArrayUtil.isEmpty(values)) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> find(Session session, final String queryString, final Integer firstResult,
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> findByNamedParam(Session session, String queryString, String[] paramNames,
            Object... values) {
        List<T> dtos = null;
        if (session != null && !StringUtil.isBlank(queryString) && !ArrayUtil.isEmpty(paramNames)
                && !ArrayUtil.isEmpty(values)) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> findByNamedParam(Session session, final String queryString, final Integer firstResult,
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> findByNamedQuery(Session session, final String queryName, final Integer firstResult,
            final Integer maxResults, final Object... values) {
        List<T> dtos = null;
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> findByNamedQueryAndNamedParam(Session session, String queryName, String[] paramNames,
            Object... values) {
        List<T> dtos = null;
        if (session != null && !StringUtil.isBlank(queryName) && !ArrayUtil.isEmpty(paramNames)
                && !ArrayUtil.isEmpty(values)) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> List<T> findByNamedQueryAndNamedParam(Session session, final String queryName,
            final Integer firstResult, final Integer maxResults, final String[] paramNames, final Object... values) {
        List<T> dtos = null;
        if (session != null && !StringUtil.isBlank(queryName) && firstResult != null && maxResults != null
                && !ArrayUtil.isEmpty(paramNames) && !ArrayUtil.isEmpty(values)) {
            final Query query = session.getNamedQuery(queryName);
     ...
     */
    public static Integer getNumberByNamedParam(Session session, String queryString, String[] paramNames,
            Object... values) {
     ...
     */
    public static Integer getNumberByNamedQueryAndNamedParam(Session session, String queryName, String[] paramNames,
            Object... values) {
     ...
     */
    public static Boolean getBooleanByNamedParam(Session session, String queryString, String[] paramNames,
            Object... values) {
        final List<?> list = findByNamedParam(session, queryString, paramNames, values);
        return CollectionUtil.getBooleanElementFromList(list);
    }
     ...
     */
    public static Boolean getBooleanByNamedQueryAndNamedParam(Session session, String queryName, String[] paramNames,
            Object... values) {
        final List<?> list = findByNamedQueryAndNamedParam(session, queryName, paramNames, values);
        return CollectionUtil.getBooleanElementFromList(list);
    }
     ...
     * @throws HibernateException the hibernate exception
     */
    public static void applyNamedParameterToQuery(Query query, String paramName, Object value)
            throws HibernateException {
