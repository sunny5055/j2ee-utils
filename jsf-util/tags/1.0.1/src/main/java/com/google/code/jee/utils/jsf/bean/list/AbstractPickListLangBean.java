package com.google.code.jee.utils.jsf.bean.list;
 ...
 * 
 * @param <RPK> the parent entity primary key type
 * @param <PK> the entity primary key type
 * @param <E> the entity type
 * @param <S> the service type
 */
@SuppressWarnings("serial")
public abstract class AbstractPickListLangBean<RPK extends Serializable, PK extends Serializable, E extends Dto<PK>, S extends GenericReadService<PK, E>>
     ...
     * 
     * @param parentPrimaryKey the parentPrimaryKey
     */
