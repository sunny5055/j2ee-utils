package com.googlecode.jutils.bundle.jpa.dao.impl;
 ...
 */
@Repository
public class LabelDaoImpl extends AbstractGenericJpaDao<LabelId, Label> implements LabelDao {
	...
	public Integer countForKey(String key) {
		return QueryUtil.getNumberByNamedQueryAndNamedParam(entityManager, LabelDao.COUNT_FOR_KEY, new String[] { "key" }, key);
	}
	...
	public List<Label> findAllByKey(String key) {
		return QueryUtil.findByNamedQueryAndNamedParam(entityManager, LabelDao.FIND_ALL_BY_KEY, new String[] { "key" }, key);
	}
	...
	public Integer countForLanguage(String language) {
		return QueryUtil.getNumberByNamedQueryAndNamedParam(entityManager, LabelDao.COUNT_FOR_LANGUAGE, new String[] { "language" }, language);
	}
	...
	public List<Label> findAllByLanguage(String language) {
		return QueryUtil.findByNamedQueryAndNamedParam(entityManager, LabelDao.FIND_ALL_BY_LANGUAGE, new String[] { "language" }, language);
	}
