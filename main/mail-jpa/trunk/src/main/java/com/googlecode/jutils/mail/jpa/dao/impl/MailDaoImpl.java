...
import com.googlecode.jutils.mail.jpa.dao.MailDao;
 ...
 */
@Repository
public class MailDaoImpl extends AbstractGenericJpaDao<Integer, Mail> implements MailDao {
	...
	public Integer countByName(String name) {
		return QueryUtil.getNumberByNamedQueryAndNamedParam(entityManager, MailDao.COUNT_BY_NAME, new String[] { "name" }, name);
	}
	...
	public Mail findByName(String name) {
		return QueryUtil.getByNamedQueryAndNamedParam(entityManager, MailDao.FIND_BY_NAME, new String[] { "name" }, name);
	}
