...
<persistence xmlns="http://java.sun.com/xml/ns/persistence"
	...
	<persistence-unit name="mail-jpa" transaction-type="RESOURCE_LOCAL">
...
<beans xmlns="http://www.springframework.org/schema/beans"
	...
	<bean id="entityManagerFactory"
		...
		<property name="persistenceUnitName" value="mail-jpa" />
...
jdbc.maxActive=100
jdbc.maxWait=1000
jdbc.url=jdbc:postgresql://localhost:5432/mail-jpa
...
public static void main(String[] args) {
	...
	mail.setFrom("john.doe@gmail.com");
	mail.setReplyTo("john.doe@gmail.com");
