 ...
 */
public abstract class AbstractGenericService<PK extends Serializable, E extends Dto<PK>, DAO extends GenericDao<PK, E>>
        extends AbstractGenericReadService<PK, E, DAO> implements GenericService<PK, E> {
