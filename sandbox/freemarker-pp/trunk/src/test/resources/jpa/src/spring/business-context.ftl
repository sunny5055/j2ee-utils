...
<@resolveKey map=config key="springBusinessFilePath" value=projectName assignTo="filePath"/>
<@resolveKey map=config key="springBusinessFileName" value=projectName assignTo="fileName"/>
