...
<@resolveKey map=config key="springTestDatabaseFilePath" value=projectName assignTo="filePath"/>
<@resolveKey map=config key="springTestDatabaseFileName" value=projectName assignTo="fileName"/>
