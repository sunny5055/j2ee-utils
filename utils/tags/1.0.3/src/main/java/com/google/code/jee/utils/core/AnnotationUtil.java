...
public final class AnnotationUtil {
     ...
     * @return the field annotation
     */
    public static <E extends Annotation> E getFieldAnnotation(Class<E> annotationClass, Class<?> clazz) {
        E annotation = null;
        if (annotationClass != null && clazz != null) {
            final List<Field> fields = ClassUtil.getFields(clazz);
            if (!CollectionUtil.isEmpty(fields)) {
                for (final Field field : fields) {
                    if (isAnnotationPresent(annotationClass, field)) {
                        annotation = getAnnotation(annotationClass, field);
                        break;
                    }
                }
            }
     ...
     */
    public static <E extends Annotation> Field getFieldWithAnnotation(Class<E> annotationClass, Class<?> clazz) {
