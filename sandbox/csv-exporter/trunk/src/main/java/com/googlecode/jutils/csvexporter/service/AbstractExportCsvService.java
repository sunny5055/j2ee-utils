...
public abstract class AbstractExportCsvService implements ExportCsvService {
     ...
     */
    private void export(OutputStream outputStream, boolean closeStream, CsvExporter exporter, List<?> values)
     ...
     * @throws NoSuchMethodException the no such method exception
     */
    private List<String> export(CsvExporter exporter, List<?> values) throws IllegalAccessException,
     ...
     * @throws NoSuchMethodException the no such method exception
     */
    private String getCellValue(CsvExporter exporter, CsvCell cell, Object value) throws IllegalAccessException,
            InvocationTargetException, NoSuchMethodException {
        String cellValue = "";
    ...
    private String formatCellValue(CsvExporter exporter, String value) {
        ...
        if (!StringUtil.isBlank(value)) {
            ...
            if (exporter.isEncapsulateValue() && !StringUtil.startsWith(value, "\"")
