...
<@resolveKey map=config key="layoutXhtmlFilePath" values=[projectName] assignTo="filePath"/>
<@resolveKey map=config key="layoutXhtmlFileName" values=[projectName] assignTo="fileName"/>
