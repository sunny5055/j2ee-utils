...
<@resolveKey map=config key="indexXhtmlFilePath" value=projectName assignTo="filePath"/>
<@resolveKey map=config key="indexXhtmlFileName" value=projectName assignTo="fileName"/>
