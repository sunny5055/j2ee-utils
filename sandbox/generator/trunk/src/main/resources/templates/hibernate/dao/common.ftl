...
<#macro getSearchMethod doc entity>
	<@xPath xml=doc expression="//h:entity[@name='${entity.@name}']/h:properties/*" assignTo="allProperties" />
  @Override
                    ...
                    if (entry.getValue() != null) {
                        ...
                        <#list allProperties as property>
				            ...
				            <#elseif property?node_name = "many-to-one">
		                 		<@xPath xml=doc expression="//h:entity[@name='${getType(property.@targetEntity)}']" assignTo="targetEntity" />
			                	<#if targetEntity??>
			                    	<@xPath xml=doc expression="//h:entity[@name='${getType(property.@targetEntity)}']/h:properties/h:column[@unique='true']" assignTo="uniqueColumns" />
